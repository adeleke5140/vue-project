...
const addCity = () => {
  ...
  updatedSavedCities.value = [...new Set(savedCities.value)]
  localStorage.setItem("savedCities", JSON.stringify(updatedSavedCities.value))
